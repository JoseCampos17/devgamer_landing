...
export const translations = {
  es: {
    ...
    "hero.title3": "ideas",
    "hero.subtitle": "Software a la Medida",
    "hero.description": "Desarrollo soluciones digitales a la medida, landing pages de alta conversión y comparto mi pasión por los videojuegos en directos únicos. Todo en un solo lugar.",
